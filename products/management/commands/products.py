...
class Command(BaseCommand):
    ...
    def add_products(self):
        ...
        url = 'https://fr-en.openfoodfacts.org/category/seafood.json'
        ...
        for i in range(len(products)):
            ...
            data = Product(name=prod_name, url=prod_url, nutrition_grade=nutriscore, category="seafood", date=timezone.now())
            data.save()
        return products
